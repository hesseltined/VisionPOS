...
$config['DX_website_name'] = 'Real Optics Inc. Database Application';
$config['DX_webmaster_email'] = 'webmaster@realopticsinc.com';
...
$config['DX_salt'] = 'qR!`vHv[p)lBGcP]G`4y8a4979)KW#?0+)u$ow(.Z%2=P{g](M`TOz$Wr856j%_7';
...
$config['DX_autologin_cookie_life'] = 60*5*0*0*0;
...
$config['DX_recaptcha_public_key'] = '6LeZSggAAAAAAMizQ2uC1eu89zkzTX3LIJ_feYpo'; 
$config['DX_recaptcha_private_key'] = '6LeZSggAAAAAAKtK1feSGcHrEkW0uBlBcN-inBdD';
...
$config['DX_captcha_registration'] = FALSE;  // Disabled 4-26-2010 Doug - to enable registration by admin and auto activation.
