...
$config['base_url']	= "http://www.gowhg.com/sandbox"; 
...
|
*/
$config['sess_cookie_name']		= 'roidatabase_session';
$config['sess_expiration']		= 7200;		//originally 7200
$config['sess_encrypt_cookie']	= FALSE;
$config['sess_use_database']	= FALSE;
$config['sess_table_name']		= 'ci_sessions';
$config['sess_match_ip']		= TRUE;
$config['sess_match_useragent']	= TRUE;
$config['sess_time_to_update'] 	= 120;	//original 300
