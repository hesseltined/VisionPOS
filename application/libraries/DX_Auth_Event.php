...

{
	...
	// REMARKED BY DOUG TO PREVENT SENDING ACTIVATION LINK - FINISH THIS LATER - TEMP REVERSED

	$data['activate_url'],
	
		$data['username'],  //just used 'UserName to fill in the blank with something
